...
export const SCENE_PRESETS: ScenePreset[] = [
  ...
  {
    id: "entheos-native-weave",
    name: "Entheos · Native Sigil",
    source: "Entheos logo · direct shader geometry",
    description: "The logo’s six colored orbs, outer ring, and pointed central sigil rendered natively with a slow luminous breath.",
    palette: ["#ff5128", "#ffd23f", "#24d77a", "#26cddd", "#4f6fff", "#b35cff"],
    masterSpeed: 0.52,
    walkSpeed: 0.1,
    walkDepth: 0.08,
    layers: [
      layer("solid", "Black velvet", {
        blend: "alpha_over", opacity: 1, speed: 0, scale: 1,
        audio_amount: 0, hue: 0.69, hue_range: 0, saturation: 0.38,
        brightness: 0.018, walk_amount: 0,
      }),
      layer("entheos_weave", "Vector-derived sigil", {
        blend: "screen", opacity: 1, speed: 0.26, scale: 1,
        audio_amount: 0.04, hue: 0.005, hue_range: 0.92, saturation: 0.94,
        brightness: 1.08, walk_amount: 0, param_a: 0.38, param_b: 0.72,
        param_c: 0.66, param_d: 0.5,
      }),
    ],
  },
  {
    id: "brc-native-led-map",
    name: "Black Rock City · LED Map",
    source: "Burning Man 2026 plan · direct shader schematic",
    description: "The iconic open-top horseshoe and pentagonal trash fence, with separated streets, Man, Temple, and Entheos at 9:15 & Esplanade.",
    palette: ["#071222", "#d98f3d", "#ffe7a3", "#27d6e8", "#ff3a20"],
    masterSpeed: 0.34,
    walkSpeed: 0.08,
    walkDepth: 0.04,
    layers: [
      layer("solid", "Night playa", {
        blend: "alpha_over", opacity: 1, speed: 0, scale: 1,
        audio_amount: 0, hue: 0.59, hue_range: 0, saturation: 0.78,
        brightness: 0.045, walk_amount: 0,
      }),
      layer("brc_map", "BRC street schematic", {
        blend: "screen", opacity: 1, speed: 0.16, scale: 1,
        audio_amount: 0, hue: 0.075, hue_range: 0.42, saturation: 0.86,
        brightness: 1.08, walk_amount: 0, param_a: 0.62, param_b: 0.7,
        param_c: 0.78, param_d: 0.5,
      }),
    ],
  },
  {
    id: "brc-native-literal-plan",
    name: "Black Rock City · Literal Plan",
    source: "Burning Man 2026 plan · direct line geometry",
    description: "A close LED trace of the published plan: continuous blue blocks, explicit quarter-hour street lines, open playa axes, pentagonal fence, and a clear Entheos star.",
    palette: ["#02060c", "#168fd3", "#61d8f2", "#fff0ba", "#ff1681", "#ff4826"],
    masterSpeed: 0.24,
    walkSpeed: 0.04,
    walkDepth: 0.02,
    layers: [
      layer("solid", "Paper black", {
        blend: "alpha_over", opacity: 1, speed: 0, scale: 1,
        audio_amount: 0, hue: 0.62, hue_range: 0, saturation: 0.6,
        brightness: 0.018, walk_amount: 0,
      }),
      layer("brc_plan", "Literal plan lines", {
        blend: "screen", opacity: 1, speed: 0.1, scale: 1,
        audio_amount: 0, hue: 0.55, hue_range: 0.08, saturation: 0.9,
        brightness: 1.08, walk_amount: 0, param_a: 0.78, param_b: 0.82,
        param_c: 0.88, param_d: 0.5,
      }),
    ],
  },
  {
